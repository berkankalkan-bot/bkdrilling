...
export default function HydraulicPage() {
  ...
  const hydraulicProducts = allProducts.filter(p => 
    p.category.toLowerCase().includes("hydraulic") || 
    p.name.toLowerCase().includes("hydraulic") ||
  ...
  // Markalar
  const brands = Array.from(new Set(hydraulicProducts.map(p => p.brand))).sort();
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-black text-white py-16 border-b-4 border-slate-700">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-5xl font-bold mb-4">HYDRAULIC PARTS</h1>
          <p className="text-xl text-slate-300">
            Hydraulic motors, pumps, valves, cylinders and accessories
          </p>
          <div className="flex gap-4 mt-6">
            <Badge variant="secondary" className="text-base py-2 px-4 bg-white text-black">
              {hydraulicProducts.length} Products
            </Badge>
            <Badge variant="secondary" className="text-base py-2 px-4 bg-white text-black">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        {hydraulicProducts.length === 0 && (
          <div className="text-center py-12">
            <Package size={48} className="mx-auto text-slate-300 mb-4" />
            <p className="text-xl text-slate-500">
              No hydraulic products found in current inventory.
            </p>
